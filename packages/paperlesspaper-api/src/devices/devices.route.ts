...
const deviceDeactivationPreviewSchema = z.object({
  ...
  appDeviceMissing: z.boolean().optional(),
...
export const devicesRouteSpecs: RouteSpec[] = [
  ...
  },
  {
    ...
    validate: [auth(), validateAdminOrSupport],
